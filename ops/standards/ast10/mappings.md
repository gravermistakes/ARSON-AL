...
| **AST05 — Untrusted External Instructions** | High | P1: Cybersecurity, P7: Audit | Phase 2 (reference pinning), Phase 4 (egress allowlist), Phase 5 (drift monitoring) | Content-hash pinning of referenced docs; Inline-over-fetch; Domain allowlist; Reference inventory and revocation |
